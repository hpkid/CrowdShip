...
<head>
    ...
    <title>Product Details | E-Shipper</title>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="shop.php"><img src="images/home/logo.gif" alt="" /></a>
						</div>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#finviet">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Finland - Viet Nam
										</a>
									</h4>
								</div>
								<div id="finviet" class="panel-collapse collapse">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#vietfin">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											Viet Nam - Finland
										</a>
									</h4>
								</div>
								<div id="vietfin" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="#">Ha Noi </a></li>
											<li><a href="#">Ho Chi Minh </a></li>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="images/product-details/luggage.jpg" alt="luggage" width="266px" height="381px" />
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Web ID: 1089772</p> -->
								<span>
									<span style=" margin-top:0px">€5 / kg</span>
									<label>Amount:</label>
									...
									<button type="button" class="btn btn-fefault cart">
										...
										Contact
                                        <h6 style="font-size:x-small;margin:0px;">(via Facebook)</h6>
									</button>
                                    
								</span>
                                <p><b>Date:</b> December 12, 2016</p>
								<p><b>Availability:</b> 10 kg</p>
								<p><b>Route:</b> Finland- HCM </p>
                                <p><b>Seller:</b> Le Nguyen Hoang Minh </p>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/product-details/luggage_rec.jpg" alt="" />
													<h2>$56</h2>
...
<?php
	...
	echo "<script>alert('Please log in to see!');
